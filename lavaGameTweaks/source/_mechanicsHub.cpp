...
namespace mechHub
{
    ...
    { 
        ...
        lid_WALLJUMP_FROM_SPECIAL_TOGGLE_P1, lid_WALLJUMP_ONCE_PER_AIR_P1, lid_TILT_CANCELS_P1, lid_SHIELD_SIZE_LOCK_P1,
        lid_SHIELD_BREAK_REDUCTION_P1, lid_SHIELD_PARRY_P1,
    };
